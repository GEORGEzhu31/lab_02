...
author: "Team Name: George Zhu, yifu li, Wanfang Zhen,Yunrui Lyu and Jiayi Wan"
date: "`r Sys.Date()`"
...
```{r load-packages, message = FALSE, warning=FALSE}read_csv()
library(tidyverse)
library(readxl)
```
...
# Member 1 write code to load File 1 data here: <- read_csv("data/mismanaged-plastic-waste-per-capita.csv")
...
# Member 1 write code to create object 'plastic_data_all':plastic_data_all <- data1
...
# Member 1 adds code here to view the first 10 rows of 'plastic_data_all'%>% head(n = 10)
